...
export type SizeMenuItemCallback = (item: ComponentOptions) => void;

export interface SizeMenuConstructorOptions {
  reference: HTMLElement | VirtualElement;
  boundary: HTMLElement;
  options: ComponentOptions[];
  itemCallback?: SizeMenuItemCallback;
  onlyText?: boolean;
  defaultItem?: boolean;
}

export class SizeMenu {
  instance?: Instance;
  popper?: HTMLElement;

  constructorOptions: SizeMenuConstructorOptions;

  constructor(options: SizeMenuConstructorOptions) {
