...
export type LineHeightMenuItemCallback = (item: ComponentOptions) => void;

export interface LineHeightMenuConstructorOptions {
  reference: HTMLElement | VirtualElement;
  boundary: HTMLElement;
  options: ComponentOptions[];
  itemCallback?: LineHeightMenuItemCallback;
  onlyText?: boolean;
  defaultItem?: boolean;
}

export class LineHeightMenu {
  instance?: Instance;
  popper?: HTMLElement;

  constructorOptions: LineHeightMenuConstructorOptions;

  constructor(options: LineHeightMenuConstructorOptions) {
