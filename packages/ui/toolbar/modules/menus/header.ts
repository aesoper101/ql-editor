...
export type HeaderMenuItemCallback = (item: ComponentOptions) => void;

export interface HeaderMenuConstructorOptions {
  reference: HTMLElement | VirtualElement;
  boundary: HTMLElement;
  options: ComponentOptions[];
  itemCallback?: HeaderMenuItemCallback;
  onlyText?: boolean;
  defaultItem?: boolean;
}
...
export class HeaderMenu {
  ...
  constructorOptions: HeaderMenuConstructorOptions;

  constructor(options: HeaderMenuConstructorOptions) {
  ...
  protected addItem(panel: HTMLElement, option: ComponentOptions) {
    ...
    item.setAttribute("data-header", option.value);
